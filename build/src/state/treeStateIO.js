...
class TreeStateIO {
    addSentStateFromNodes(nodes, update) {
        const newSentState = new TreeState(this.currentSentStateIdx + 1, this.currentTreeState._sentence_id, this.currentTreeState._lang, [], nodes, this.currentTreeState.clickState);
    ...
    constructor(sentState) {
        ...
        const newSentState = new TreeState(sentState._state_id, sentState._sentence_id, sentState._lang, tokensWithRoot, nodes, sentState._clickState);
...
TreeStateIO.replaceSentStateFromNodes = (nodes, update, idx) => (state) => {
    const newSentState = new TreeState(state.currentSentStateIdx + 1, state.currentTreeState._sentence_id, state.currentTreeState._lang, [], nodes, state.currentTreeState.clickState);
